...
reportstartday = '2016-03-14';
reportendday = '2015-03-20';
...
direction = EB;
figurenum=twoweekplot(TrafficData,startdatenum,minspeed,maxspeed,figurenum,milemarker,direction,groupname,reportstartday,sensornames(2*i,:));
export_fig([y '\5.daily_rawheatmap.pdf'],'-append')

figurenum=dailysensorissue(EBissue,startdatenum,figurenum,milemarker,direction,groupname,reportstartday,sensornames(2*i,:));
export_fig([y '\daily_sensor_issues.pdf'],'-append')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
TrafficData=EBspeednorm(:,:,1:end);                  % change this
direction = EB;
figurenum=twoweekplotnorm(TrafficData,startdatenum,minspeed,maxspeed,figurenum,milemarker,direction,groupname,reportstartday);
...
figurenum=dailysensorissue(WBissue,startdatenum,figurenum,milemarker,direction,groupname,reportstartday,sensornames(2*i,:));
export_fig([y '\daily_sensor_issues.pdf'],'-append')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
figurenum=onetypeofsensorissue(EBoff,startdatenum,figurenum,milemarker,EB,groupname,reportstartday,sensornames(2*i,:),[0,0,0],'off');
export_fig([y '\2.daily_sensor_issues_seperate.pdf'],'-append')
figurenum=onetypeofsensorissue(WBoff,startdatenum,figurenum,milemarker,WB,groupname,reportstartday,sensornames(2*i,:),[0,0,0],'off');
export_fig([y '\2.daily_sensor_issues_seperate.pdf'],'-append')
figurenum=onetypeofsensorissue(EBfail,startdatenum,figurenum,milemarker,EB,groupname,reportstartday,sensornames(2*i,:),[255,0,0],'fail');
export_fig([y '\2.daily_sensor_issues_seperate.pdf'],'-append')
figurenum=onetypeofsensorissue(WBfail,startdatenum,figurenum,milemarker,WB,groupname,reportstartday,sensornames(2*i,:),[255,0,0],'fail');
export_fig([y '\2.daily_sensor_issues_seperate.pdf'],'-append')
figurenum=onetypeofsensorissue(EBzerospeednonzerocount,startdatenum,figurenum,milemarker,EB,groupname,reportstartday,sensornames(2*i,:),[100,200,0],'zerospeednonzerocount');
export_fig([y '\2.daily_sensor_issues_seperate.pdf'],'-append')
figurenum=onetypeofsensorissue(WBzerospeednonzerocount,startdatenum,figurenum,milemarker,WB,groupname,reportstartday,sensornames(2*i,:),[100,200,0],'zerospeednonzerocount');
export_fig([y '\2.daily_sensor_issues_seperate.pdf'],'-append')
figurenum=onetypeofsensorissue(EBmissingveh,startdatenum,figurenum,milemarker,EB,groupname,reportstartday,sensornames(2*i,:),[109,196,239],'missingveh');
export_fig([y '\2.daily_sensor_issues_seperate.pdf'],'-append')
figurenum=onetypeofsensorissue(WBmissingveh,startdatenum,figurenum,milemarker,WB,groupname,reportstartday,sensornames(2*i,:),[109,196,239],'missingveh');
export_fig([y '\2.daily_sensor_issues_seperate.pdf'],'-append')
figurenum=onetypeofsensorissue(EBclassmisscount,startdatenum,figurenum,milemarker,EB,groupname,reportstartday,sensornames(2*i,:),[255,135,44],'classmisscount');
export_fig([y '\2.daily_sensor_issues_seperate.pdf'],'-append')
figurenum=onetypeofsensorissue(WBclassmisscount,startdatenum,figurenum,milemarker,WB,groupname,reportstartday,sensornames(2*i,:),[255,135,44],'classmisscount');
export_fig([y '\2.daily_sensor_issues_seperate.pdf'],'-append')
