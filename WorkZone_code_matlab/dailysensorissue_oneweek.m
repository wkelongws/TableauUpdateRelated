function figurenum=dailysensorissue_oneweek(TrafficData,startdatenum,figurenum,milemarker,direction,groupname,reportstartday,sensornames)
...
set(gca,'XGrid','on')
    ...
    issues={'normal','off','fail','zerospeednonzerocount','missingveh','lose connection','classmisscount'};
    for j=1:levels
    ...
    caxis([0,60]);
    hcb=colorbar;
 set(hcb,'YTick',[0,10,20,30,40,50,60])
 set(hcb,'YTickLabel',{'','','','','','',''})
