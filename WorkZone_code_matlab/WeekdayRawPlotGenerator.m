function figurenum=WeekdayRawPlotGenerator(AverageSpeed,minspeed,maxspeed,figurenum,reportstartday,reportendday,y)
...
export_fig([y '\4.WeekdayRawHeatmaps.pdf'],'-append')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
for i=1:size(AverageSpeed,1)
...
datadisplayspeed(TrafficData,minspeed,maxspeed); 
    ...
    sensorID=cell2mat(AverageSpeed(i,7));
    sensorname=AverageSpeed(i,8);
    ...
    x=AverageSpeed(i,1); 
    title([x{1} ': weekday average ' reportstartday ' 00:00 - ' reportendday ' 23:59'],'FontSize', 24);
 
    set(gca,'YTick',1:size(TrafficData,1))
    set(gca,'YTickLabel',sensorname,'FontSize', 24)

set(gca,'XTick',[36 72 108 144 180 216 252])
set(gca,'XTickLabel',{'3:00am','6:00am','9:00am','12:00pm','3:00pm','6:00pm','9:00pm'},'FontSize', 24)
xlabel('time of day','FontSize', 24);
set(gca,'XGrid','on','LineWidth',1.5)
export_fig([y '\4.WeekdayRawHeatmaps.pdf'],'-append')
end
close all;
end
