...
days=floor((1:oneday*7:size(spreadsheet,2))/288)+startdatenum;
day=cellstr(datestr(days));
timetick=xcoordinate((1:oneday*7:size(spreadsheet,2)));
timeticklabel=day;
...
export_fig([y '\' groupname '\'   reportstartday '-' reportendday '_' groupname '_Shockwaves.pdf'],'-append')
