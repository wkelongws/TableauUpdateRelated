function [WBspeed,EBspeed,WBvolume,EBvolume,WBissue,EBissue,startdatenum,...
    ...
    =SpeedMatrixReduction20s(speeddata,milemarker,timeinterval,WB,EB,reportstartday)
...
for k=1:size(celldata,1)
    ...
    for j=1:size(cellonedaydata,1)
        ...
        onedetectordata(:,2)=onedetectordata(:,3)*60+floor(onedetectordata(:,4))+(onedetectordata(:,4)-floor(onedetectordata(:,4)))*100/60+0.1;  % convert timestamp to number of 5 mins
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        onedetectordata=[onedetectordata,zeros(size(onedetectordata,1),1)]; % insert the key colume
