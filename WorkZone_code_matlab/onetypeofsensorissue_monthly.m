function figurenum=onetypeofsensorissue_monthly(TrafficData,startdatenum,figurenum,milemarker,direction,groupname,reportstartday,sensornames,color,issue)
