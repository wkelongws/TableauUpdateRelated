...
% [EBvolumenorm]=distanceinterpolation(EBvolume,milemarker,distanceinterval,method,EB);
% 
% 
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% TrafficData=EBspeednorm; 
% [eventnum, maxduration, avgduration, maxlength, avglength,filteredeventnum]=performance(TrafficData);
% VolumeData=EBvolumenorm;
% refspeed = 65;
% [volumn,avgdelay] = delay(TrafficData,VolumeData,refspeed);
% 
% speedlimit=[120.8,70,65;122.45,65,60;129.7,60,55];
% speedlimit=[27.8,70,65;44.3,65,60;116.8,60,55];
% totaldelaydata = TravelTimeDef(TrafficData,VolumeData,speedlimit);
% 
...
method='linear'; % 'spline' or 'linear' or 'cube'   % change this
distanceinterval=0.1; % mile                        % change this
WBspeed(22,70:75,12)=nan;
[WBspeednorm]=distanceinterpolation(WBspeed,milemarker,distanceinterval,method,WB);
[WBvolumenorm]=distanceinterpolation(WBvolume,milemarker,distanceinterval,method,WB);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

TrafficData=WBspeednorm; 
[eventnum, maxduration, avgduration, maxlength, avglength,filteredeventnum]=performance(TrafficData);
VolumeData=WBvolumenorm;
refspeed = 65;
[volumn,avgdelay] = delay(TrafficData,VolumeData,refspeed);



speedlimit=[140.2,70,55;146,55,50;148.48,50,55;149.52,55,65];
speedlimit=[9.5,70,55;67.5,55,50;92.3,50,55;102.7,55,65];
totaldelaydata = TravelTimeDef(TrafficData,VolumeData,speedlimit);
