function figurenum=Avgplotnorm(AverageSpeed,minspeed,maxspeed,figurenum,reportstartday,reportendday,y)
...
for i=1:size(AverageSpeed,1)
    ...
    for j = 1:length(wzmarker)
        wzloc(j)=(wzmarker(j)-milemarker(1))/(milemarker(end)-milemarker(1))*(size(TrafficData,1)-1)+1;
    end
...
set(gca,'XGrid','on')
 ...
 text(0,0.9,'Weekday Average Speed Heatmap - Smoothed','FontWeight','bold','FontSize',12)
...
set(gca,'XGrid','on')
 ...
 text(0,0.3,'\uparrow Direction 2','FontWeight','bold','FontSize',12)
 text(0,0.6,'\downarrow Direction 1','FontWeight','bold','FontSize',12)
 text(0,0.9,'Weekend Average Speed Heatmap - Smoothed','FontWeight','bold','FontSize',12)
 text(0,0,[reportstartday ' 00:00 - ' reportendday ' 23:59'],'FontWeight','bold','FontSize',12)
