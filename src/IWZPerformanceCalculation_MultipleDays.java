...
public class IWZPerformanceCalculation_MultipleDays {
	    ...
	    try
	    {
	        ...
	        for (ChannelSftp.LsEntry oListItem : list) {
	            ...
	            if (!oListItem.getAttrs().isDir()) 
	            {
	                ...
	                String localFile = "performance_daily-2017.csv";
...
//	                  pw.append("\n");                	
	            	...
	            	String date = M + "/" + D + "/" + Y;
	            	 ...
	            	 String line_Dir1 = DATE.toString("MM/dd/yyyy") + "," + remoteFile.split(".txt")[0] + ",1," + volume_Dir1 + "," + timeWhenLowSpeedsOccur_Dir1/288.0 + "," + (double)vehWhenLowSpeedsOccur_Dir1/volume_Dir1
	                 ...
	                 //pw1.append("\n");
	                 String line_Dir2 = DATE.toString("MM/dd/yyyy") + "," + remoteFile.split(".txt")[0] + ",2," + volume_Dir2 + "," + timeWhenLowSpeedsOccur_Dir2/288.0 + "," + (double)vehWhenLowSpeedsOccur_Dir2/volume_Dir2
